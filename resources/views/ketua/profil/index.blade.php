    ...
    <div class="flex flex-col lg:grid max-md:grid-rows-1 lg:grid-cols-3 bg-white mx-5 mt-5 rounded-[15px] gap-0">
        ...
        <div class="col-span-2 w-full h-full lg:py-10 pt-2">
                <div class="flex flex-col py-[30px] lg:my-[55px] lg:py-[55px] mr-0 md:mr-[51px] lg:bg-gray-200 lg:rounded-[15px] gap-[15px] lg:gap-[60px]">
                    ...
                    <div class="flex flex-col lg:grid pt-0 lg:grid-cols-2 justify-between px-[20px] md:px-[61px]">
                        <p>Password</p>
                        ...
                        <span class="text-neutral-500 lg:text-base text-sm" style="grid-column: 2">kosongkan jika tidak ingin memperbarui</span>
                        @error('password')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
