            ...
            <div class="grid md:grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
                <div class="md:col-span-1 flex flex-col gap-[23px] order-2">
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] " id="page_1">
                        ...
                        <input type="text" step="any" name="kode" value="{{old('kode', $kriteria->kode)}}" class="w-100 text-sm font-normal border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" placeholder="Masukkan kode kriteria awali dengan huruf C" disabled>
                        @error('kode')
                ...
                <div class="md:col-span-1 flex flex-col gap-[23px] order-2">
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] " id="page_1">
                        ...
                        <input type="text" step="any" name="jenis" value="{{old('jenis', $kriteria->jenis)}}" class="w-100 text-sm font-normal border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" placeholder="Masukkan jenis kriteria" required>
                        @error('jenis')
                            <span class="text-red-500 message">{{$message}}</span>
                        @enderror
                    </div>
