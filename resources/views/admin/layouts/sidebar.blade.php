<aside class="static lg:fixed flex bg-white w-[236.094px] h-screen lg:h-full justify-center shadow-inner">
    <div class="content flex flex-col w-full gap-10 pt-10 mx-7">
        ...
        <a href="{{ url('admin/') }}" class="containerSidebar active:bg-blue-900 {{ ($activeMenu == 'lansia')? 'active stroke-white' : 'stroke-neutral-950 hover:text-white hover:bg-blue-600 hover:stroke-white'}}">
