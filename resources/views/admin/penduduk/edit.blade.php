            ...
            <div class="grid md:grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
                ...
                <div class="md:col-span-1 flex flex-col gap-[23px] order-2">
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] " id="page_1">
                        ...
                        <textarea class="text-sm font-normal border border-stone-400 px-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" name="alamat" id="alamat" rows="1" maxlength="200" required>{{old('alamat', $penduduk->alamat)}}</textarea>
                        @error('alamat')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
