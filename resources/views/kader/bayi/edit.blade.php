        ...
        <div class="flex flex-col bg-white mx-5 my-5 shadow-[0_-4px_0_0_rgba(248,113,113,1)] rounded-md">
            ...
            <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
                <div class="col-span-1 flex flex-col gap-[23px]">
                    <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                        ...
                        <input name="filter" id="filter" class="w-100 border text-gray-300 border-stone-400 text-sm font-normal pl-[10px] py-[10px] rounded-[5px] focus:outline-none" value="{{$bayiData->penduduk->nama}}" disabled>
                    </div>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                        ...
                        <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{  now()->diffInMonths($bayiData->penduduk->tgl_lahir) }}" placeholder="Masukkan usia balita" disabled>
                    </div>
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        <p class="text-base text-neutral-950">Usia<span class="text-red-400">*</span></p>
                        <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{  now()->diffInMonths($bayiData->penduduk->tgl_lahir) }}" placeholder="Masukkan usia balita" disabled>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <input type="text" name="berat_badan" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->berat_badan }}" placeholder="Masukkan berat badan">
                    </div>
                    <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                ...
                <div class="col-span-1 flex flex-col gap-[23px]">
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <input type="text" name="lingkar_lengan" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->pemeriksaan_bayi->lingkar_lengan }}" placeholder="Masukkan lingkar lengan">
                    </div>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <div class="flex gap-10">
                            @if($bayiData->pemeriksaan_bayi->kenaikan === 'iya')
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="kenaikan" id="option1" checked><span>Ya</span>
                            ...
                            @else
                                ...
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] checked:w-4 checked:outline-2 -mr-[25px]" name="kenaikan" id="option2" checked><span>Tidak</span>
                            @endif
                        </div>
                    </div>
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <div class="flex gap-10">
                            @if($bayiData->pemeriksaan_bayi->asi === 'iya')
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="asi" id="option1" checked><span>Ya</span>
                            ...
                            @else
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="asi" id="option1" checked><span>Ya</span>
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] checked:w-4 checked:outline-2 -mr-[25px]" name="asi" id="option2" checked><span>Tidak</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 mx-10 gap-x-[101px] pb-[30px]">
                <div class="col-span-1 flex flex-col w-full h-fill gap-[20px]" id="page_1">
                    ...
                    <input name="data_kb" id="data_kb" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->pemeriksaan_bayi->data_kb }}">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950 pr-[10px]">Tinggi Badan<span class="text-red-400">*</span></p>
                    <input type="text" name="tinggi_badan" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->tinggi_badan }}" placeholder="Masukkan tinggi badan">
                </div>
