        ...
        <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
            <div class="col-span-1 flex flex-col gap-[23px]">
                ...
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{  now()->diffInMonths($bayiData->penduduk->tgl_lahir) }}" placeholder="Masukkan usia balita">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950">Usia<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{  now()->diffInMonths($bayiData->penduduk->tgl_lahir) }}" placeholder="Masukkan usia balita">
                ...
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="" placeholder="Masukkan nama ibu">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950">Berat Badan<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->berat_badan }}" placeholder="Masukkan berat bedan">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
            ...
            <div class="col-span-1 flex flex-col gap-[23px]">
                ...
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->pemeriksaan_bayi->lingkar_lengan }}" placeholder="Masukkan lingkar lengan">
                </div>
        ...
        <div class="grid grid-cols-2 mx-10 gap-x-[101px] pb-[30px]">
            <div class="col-span-1 flex flex-col w-full h-fill gap-[20px]" id="page_1">
                ...
                <select name="filter" id="filter" class="w-100 border border-stone-400 text-gray-300 text-sm font-normal pl-[10px] py-[10px] rounded-[5px] focus:outline-none">
                    <option value="{{ $bayiData->pemeriksaan_bayi->data_kb }}" class=""></option>
                </select>
            </div>
            <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                <p class="text-base text-neutral-950 pr-[10px]">Tinggi Badan<span class="text-red-400">*</span></p>
                <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $bayiData->tinggi_badan }}" placeholder="Masukkan tinggi badan">
            </div>
