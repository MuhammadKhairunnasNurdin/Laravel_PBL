            ...
            <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
                <div class="col-span-1 flex flex-col gap-[23px]">
                    <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                        ...
                        <input name="nama" id="filter" class="w-100 border text-gray-300 border-stone-400 text-sm font-normal pl-[10px] py-[10px] rounded-[5px] focus:outline-none" value="{{$bayiData->penduduk->nama}}" disabled>
                    </div>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <div class="flex gap-10">
                            @if($bayiData->pemeriksaan_bayi->kenaikan === 'iya')
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="kenaikan" value="iya" id="option1" checked><span>Ya</span>
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] checked:w-4 checked:outline-2 -mr-[25px]" name="kenaikan" value="tidak" id="option2"><span>Tidak</span>
                            @else
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="kenaikan" value="iya" id="option1"><span>Ya</span>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                        ...
                        <div class="flex gap-10">
                            @if($bayiData->pemeriksaan_bayi->asi === 'iya')
                                <input type="radio" class="indeterminate:outline-2 indeterminate:outline-stone-400 indeterminate:w-4 indeterminate:py-[20px] rounded-[5px] checked:w-4 checked:outline-2 checked:bg-red-400 checked:border-transparent -mr-[25px]" name="asi" value="iya" id="option1" checked><span>Ya</span>
