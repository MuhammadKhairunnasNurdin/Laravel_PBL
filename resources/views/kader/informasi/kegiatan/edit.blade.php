...
@section('content')
    <div class="flex flex-col bg-white mx-5 my-5 rounded-md">
        <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
            <div class="col-span-1 flex flex-col gap-[23px]">
                <div class="flex flex-col w-full h-fill gap-[20px]">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $kegiatans->nama}}" placeholder="Masukkan nama kegiatan">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px]">
                    <p class="text-base text-neutral-950">Tempat</p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $kegiatans->tempat}}" placeholder="Masukkan tempat pelaksanaan">
                </div>
            </div>
                ...
                <div class="flex flex-col w-full h-fill gap-[23px]">
                    ...
                    <div class="flex flex-col w-full h-fill gap-[20px]">
                        ...
                        <div class="flex gap-x-5 items-center me-[337px]">
                            <input type="text" class=" w-[83px] text-sm text-center font-normal border border-stone-400 py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $kegiatans->jam_mulai}}" placeholder="Jam Mulai">
        ...
        <div class="flex justify-end items-end gap-[26px] px-[50px] pb-10 w-full h-full">
            <a href="{{ url('kader/informasi/kegiatan')}}" class="bg-gray-300 text-neutral-950 font-bold text-base py-[10px] px-[10px] rounded-[5px]">Kembali</a>
