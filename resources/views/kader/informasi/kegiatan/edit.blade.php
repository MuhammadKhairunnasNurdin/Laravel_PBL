            ...
            <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
                <div class="col-span-1 flex flex-col gap-[23px]">
                    <div class="flex flex-col w-full h-fill gap-[20px]">
                        ...
                        <input type="text" name="nama" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $kegiatan->nama}}" placeholder="Masukkan nama kegiatan">
                    </div>
                    <div class="flex flex-col w-full h-fill gap-[20px]">
                        <p class="text-base text-neutral-950">Tempat</p>
                        <input type="text" name="tempat" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $kegiatan->tempat}}" placeholder="Masukkan tempat pelaksanaan">
                    </div>
                </div>
                    ...
                    <div class="flex flex-col w-full h-fill gap-[23px]">
                        ...
                        <div class="flex flex-col w-full h-fill gap-[20px]">
                            ...
                            <div class="flex gap-x-5 items-center me-[300px]">
                                <input type="text" id="timeInput" pattern="[0-9]{2}:[0-9]{2}" name="jam_mulai" class="w-full text-sm text-center font-normal border border-stone-400 py-[10px] px-2.5 rounded-[5px] decoration-none focus:outline-none placeholder:text-gray-300" value="{{ date('H:i', strtotime($kegiatan->jam_mulai)) }}" placeholder="Jam Mulai">
