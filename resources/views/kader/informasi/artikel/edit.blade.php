    ...
    <div class="flex flex-col bg-white mx-5 my-5 rounded-md">
        <div class="grid grid-cols-3 my-[30px] mx-10 gap-x-[101px]">
            <div class="col-span-2 flex flex-col gap-[23px]">
                <div class="flex flex-col w-full h-fill gap-[20px]">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $artikels->judul}}" placeholder="Masukkan judul artikel">
        ...
        <div class="grid grid-cols-3 mx-10 gap-x-[101px] pb-[30px]">
            <div class="flex flex-col col-span-2 w-full h-fill gap-[20px]">
                ...
                <textarea type="text" id="comment" class="text-sm font-normal border border-stone-400 px-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" rows="10" placeholder="Tuliskan isi artikel">{{ $artikels->isi }}</textarea>
            ...
            <div class="col-span-1 flex  justify-end items-end gap-[26px] w-full h-full">
                <a href="{{ url('kader/informasi/artikel')}}" class="bg-gray-300 text-neutral-950 font-bold text-base py-[10px] px-[10px] rounded-[5px]">Kembali</a>
