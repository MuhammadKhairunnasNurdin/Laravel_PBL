        ...
        <div class="grid grid-cols-2 my-[30px] mx-10 gap-x-[101px]">
            <div class="col-span-1 flex flex-col gap-[23px]">
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                    ...
                    <select name="filter" id="filter" class="w-100 border border-stone-400 text-gray-300 text-sm font-normal pl-[10px] pr-[300px] py-[10px] rounded-[5px] focus:outline-none">
                        ...
                        <option value="{{ $lansiaData->penduduk->nama}}" class="text-neutral-950" selected>{{ $lansiaData->penduduk->nama }}</option>
                    </select>
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->berat_badan}}" placeholder="Masukkan berat badan">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                ...
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->tinggi_badan}}" placeholder="Masukkan tinggi badan">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px]" id="page_1">
                    <p class="text-base text-neutral-950 pr-[10px]">Alamat<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->penduduk->alamat }}" placeholder="Masukkan alamat">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950">Lingkar Perut<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{$lansiaData->lingkar_perut}}" placeholder="Masukkan lingkar perut">{{$lansiaData->lingkar_perut}}
                </div>
            </div>
            ...
            <div class="col-span-1 flex flex-col gap-[23px]">
                <div class="flex flex-col w-full h-full gap-[20px]" id="page_1">
                    ...
                    <textarea type="text" id="comment" class="text-sm font-normal border border-stone-400 px-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" rows="5" maxlength="200" placeholder="Masukkan respon pengunjung">{{ $lansiaData->respon }}</textarea>
                ...
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    ...
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->gula_darah}}" placeholder="Masukkan gula darah">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950">Asam Urat<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->asam_urat}}" placeholder="Masukkan asam urat">
                </div>
                <div class="flex flex-col w-full h-fill gap-[20px] hidden" id="page_2">
                    <p class="text-base text-neutral-950">Kolesterol<span class="text-red-400">*</span></p>
                    <input type="text" class="w-100 text-sm font-normal border border-stone-400 pl-[10px] py-[10px] rounded-[5px] focus:outline-none placeholder:text-gray-300" value="{{ $lansiaData->kolesterol }}" placeholder="Masukkan kolesterol">
                </div>
            </div>
        </div>
